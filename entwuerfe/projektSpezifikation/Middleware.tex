...
%\begin{figure}[H]
%\includegraphics[width=1\textwidth]{middleware/Middleware_Class_final.png}{TODO}
...
%\end{figure}
%\begin{figure}[H]
%\includegraphics[width=1\textwidth]{interface_frontend_intervallquery.png}{TODO}
...
%\end{figure}
%\begin{figure}[H]
%\includegraphics[width=1\textwidth]{interface_frontend_namesearch.png}{TODO}
...
%\end{figure}
%\begin{figure}[H]
%\includegraphics[width=1\textwidth]{interface_frontend_prefixquery.png}{TODO}
