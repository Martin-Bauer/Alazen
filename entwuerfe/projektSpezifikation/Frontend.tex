...
\end{description}
% Mock-Ups
\includepicture[width=\textwidth]{gui/gb_mockup_detail_view_num.png}{Die Detail-Ansicht des Genom Browsers.}
\includepicture[width=\textwidth]{gui/gb_mockup_index_view_num.png}{Die Aggregierte-Ansicht des Genom Browsers.}
